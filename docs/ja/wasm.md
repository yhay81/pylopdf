...
exampleは入力を4 MiB、rendering／extraction用の完全なPDF snapshotを16 MiB、
累積位置付きtextを16,384 glyph recordに制限し、structureと展開後dataにも
`DocumentLimits.web()`より厳しいbudgetを設定します。
