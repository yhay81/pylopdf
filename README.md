...
| `annots()` / `get_links()` | Bounded annotation/link reads, including cycle-aware named destinations (4,096 annotations and 1 MiB aggregate metadata text per call; display coordinates) |
